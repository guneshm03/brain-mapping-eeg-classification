...
This project is a modern Python implementation and expansion of the 2013 "Brain Mapping Using MATLAB Technology" research project. Maintained by Gunesh Mahajan, it demonstrates advanced biomedical signal processing capabilities through a professional web application that classifies EEG (electroencephalogram) signals as normal or abnormal using 2D Discrete Wavelet Transform.
...
2. Preprocessing: Grayscale conversion and normalization to 256x256 pixels
...
| Image Dimensions | 256x256 | Standard size for consistent processing and comparison |
...
git clone https://github.com/guneshm007/brain-mapping-eeg.git
...
- Processing Time: ~2-3 seconds per 256x256 image
...
**Gunesh Mahajan**
Product Manager | Healthcare Technology Specialist

Gunesh is a Product Manager with 4 years of experience delivering customer-centric digital products across healthcare technology and health insurance environments. This project represents a synthesis of technical signal processing and product-driven engineering, focusing on scalable digital healthcare solutions.

- Email: guneshmahajan574@gmail.com
- LinkedIn: https://www.linkedin.com/in/guneshm007/
- Expertise: Product Strategy, Agile Development, SQL, and Data-Driven Decision Making.

**Note for Recruiters**: This project demonstrates expertise in signal processing, web development, scientific computing, and software engineering best practices. The implementation showcases the ability to translate academic research into production-ready applications with professional user interfaces and robust architecture.